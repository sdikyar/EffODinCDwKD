...
class DetectionDistiller_Retina_FBG_LOG(BaseDetector):
    ...
    def __init__(self,
        ...
        super(DetectionDistiller_Retina_FBG_LOG, self).__init__()
    ...
    def forward_train(self, 
        ...
        student_loss = self.student.forward_train(img, img_metas, pd_img, **kwargs)

        with torch.no_grad():
            fea_t = self.teacher.extract_feat(pd_img)

...
class DetectionDistiller_Retina_FBG(BaseDetector):
    ...
    def __init__(self,
        ...
        super(DetectionDistiller_Retina_FBG, self).__init__()
    ...
    def forward_train(self, 
        ...
        student_loss = self.student.forward_train(img, img_metas, t_img=t_img, **kwargs)

        with torch.no_grad():
            fea_t = self.teacher.extract_feat(t_img)

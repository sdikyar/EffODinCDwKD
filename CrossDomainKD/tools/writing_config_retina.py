def over_write(global_trans1, global_trans2, global_trans3, config_path):
    code = f"""
_base_ = [
    '../../_base_/datasets/coco_detection_pd.py',
    '../../_base_/schedules/schedule_2x.py', '../../_base_/default_runtime.py'
]
work_dir = './work_dirs/retina_detkds_optuna_PD'
# model settings
...
distiller = dict(
    ...
    distill_cfg = [ dict(student_module = 'neck.fpn_convs.4.conv',
                         ...
                         methods=[dict(type='FeatureLoss',
                                       ...
                                       global_trans1='{global_trans1}',
                                       global_trans2='{global_trans2}',
                                       global_trans3='{global_trans3}',
                                       global_dis='l1',
                                       gb_enable=True,
                                       fbg_trans1='no',
                                       fbg_trans2='no',
